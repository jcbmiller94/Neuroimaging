...
%
% Use SPM's model specification function to set up combined GLM for sessions 
%
% TO CHECK FOR EACH USE: 
%  - 
%  - Filter for selected files (e.g., '^sar' for session 1, '^sra' for session 2)  
%
%-----------------------------------------------------------------------
...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^sra';
...
matlabbatch{3}.spm.stats.fmri_spec.dir = {b.spmDir}; % '/home/despoB/jam124/BiCoWM/derivatives_test/s01/GLM_batched'
...
matlabbatch{3}.spm.stats.fmri_spec.sess.scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sar)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{3}.spm.stats.fmri_spec.sess.scans(2) = cfg_dep('File Selector (Batch Mode): Selected Files (sra)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
% save matlabbatch into .mat file
name = strcat(b.curSubj, '_model_specification.mat'); 
